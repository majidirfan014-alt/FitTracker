...
$workoutFile = 'data/workouts.json';
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="progress.php"><i class="bi bi-graph-up"></i> Progress</a></li>
                    <li class="nav-item"><a class="nav-link" href="workout.php"><i class="bi bi-lightning"></i> Latihan</a></li>
                    <li class="nav-item"><a class="nav-link" href="reports.php"><i class="bi bi-file-earmark-bar-graph"></i> Laporan</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container py-4">
        <div class="mb-3 no-print">
            <a href="progress.php" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left"></i> Kembali ke Progress</a>
